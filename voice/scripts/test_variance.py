#!/usr/bin/env python3
"""Test CosyVoice2 generation variance - run 3 times, evaluate each."""
...
def main():
    ...
    print("\n" + "=" * 50)
    print("VARIANCE TEST: 3 generations of same input")
    print("=" * 50)

    for run in range(1, 4):
        output_path = OUTPUT_DIR / f"variance_test_{run}.wav"
