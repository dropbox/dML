...
|------------|--------|-------------|
| soak_test_quick | PASS | 486,550 ops @ 8,108 ops/s |
...
| test_real_models_parallel | PASS | MLP 1849 ops/s, Conv1D 1485 ops/s |
| test_platform_specific | PASS | All platform tests pass |
| test_semaphore_recommended | PASS | 1,038 ops/s (19% over Lock) |
